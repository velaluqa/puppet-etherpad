...
class etherpad(
  ...
  $etherpad_db_type                = $etherpad::params::etherpad_db_type,
  $etherpad_mysql_user             = $etherpad::params::etherpad_mysql_user,
  $etherpad_mysql_host             = $etherpad::params::etherpad_mysql_host,
  $etherpad_mysql_password         = $etherpad::params::etherpad_mysql_password,
  $etherpad_mysql_database         = $etherpad::params::etherpad_mysql_database,
